...
class Invoices extends Component
{
    ...
    {
        $data = $this->validate([
            's_name' => ['required', 'string', 'min:5', 'max:255'],
            's_father' => ['required', 'string', 'min:5', 'max:255'],
            's_cnic' => ['required', 'string', 'min:5', 'max:255'],
            's_phone' => ['required', 'string', 'min:5', 'max:255'],
            's_address' => ['required', 'string', 'min:5', 'max:255'],
            'b_name' => ['required', 'string', 'min:5', 'max:255'],
            'b_father' => ['required', 'string', 'min:5', 'max:255'],
            'b_cnic' => ['required', 'string', 'min:5', 'max:255'],
            'b_phone' => ['required', 'string', 'min:5', 'max:255'],
            'b_address' => ['required', 'string', 'min:5', 'max:255'],
            'reg_no' => ['required', 'string', 'min:5', 'max:255'],
            'chassis_no' => ['required', 'string', 'min:5', 'max:255'],
            'engine_no' => ['required', 'string', 'min:5', 'max:255'],
            'mark' => ['required', 'string', 'min:5', 'max:255'],
            'hp' => ['required', 'string', 'min:5', 'max:255'],
            'model' => ['required', 'string', 'min:5', 'max:255'],
            'kota' => ['required', 'string', 'min:5', 'max:255'],
            'post_office' => ['required', 'string', 'min:5', 'max:255'],
            'reg_book' => ['required', 'string', 'min:5', 'max:255'],
            'reg_file' => ['required', 'string', 'min:5', 'max:255'],
            'file_pg' => ['required', 'string', 'min:5', 'max:255'],
            'no_plate' => ['required', 'string', 'min:5', 'max:255'],
            'car_color' => ['required', 'string', 'min:5', 'max:255'],
            'amount' => ['required', 'string', 'min:5', 'max:255'],
            'amount_words' => ['required', 'string', 'min:5', 'max:255'],
            'w1_name' => ['required', 'string', 'min:5', 'max:255'],
            'w1_father' => ['required', 'string', 'min:5', 'max:255'],
            'w1_phone' => ['required', 'string', 'min:5', 'max:255'],
            'w1_address' => ['required', 'string', 'min:5', 'max:255'],
            'w2_name' => ['required', 'string', 'min:5', 'max:255'],
            'w2_father' => ['required', 'string', 'min:5', 'max:255'],
            'w2_phone' => ['required', 'string', 'min:5', 'max:255'],
            'w2_address' => ['required', 'string', 'min:5', 'max:255'],
        ]);
