...
class Invoices extends Component
{
    ...
    public function store()
    {
        $data = $this->validate([
            ...
            'w1_father' => ['required', 'string', 'max:255'],
            'w1_phone' => ['required', 'string', 'max:255'],
            'w1_address' => ['required', 'string', 'max:255'],
            'w2_name' => ['required', 'string', 'max:255'],
            'w2_father' => ['required', 'string', 'max:255'],
            'w2_phone' => ['required', 'string', 'max:255'],
            'w2_address' => ['required', 'string', 'max:255'],
        ]);
