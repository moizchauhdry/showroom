                    ...
                    <div class="card p-4 mb-4">
                        <div class="row">
                            <div class="col-md-3 form-group mb-2">
                                ...
                                <input type="text" class="form-control" wire:model="reg_no" id="reg_no">
                                @error('reg_no') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="chassis_no">Chassis No.</label>
                                <input type="text" class="form-control" wire:model="chassis_no" id="chassis_no">
                                @error('chassis_no') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="engine_no">Engine No.</label>
                                <input type="text" class="form-control" wire:model="engine_no" id="engine_no">
                                @error('engine_no') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="mark">Mark</label>
                                <input type="text" class="form-control" wire:model="mark" id="mark">
                                @error('mark') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="hp">HP</label>
                                <input type="text" class="form-control" wire:model="hp" id="hp">
                                @error('hp') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="model">Model</label>
                                <input type="text" class="form-control" wire:model="model" id="model">
                                @error('model') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="kota">Kota</label>
                                <input type="text" class="form-control" wire:model="kota" id="kota">
                                @error('kota') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="post_office">Post Office</label>
                                <input type="text" class="form-control" wire:model="post_office" id="post_office">
                                @error('post_office') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="reg_book">Registration Book</label>
                                <input type="text" class="form-control" wire:model="reg_book" id="reg_book">
                                @error('reg_book') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="reg_file">Registration File</label>
                                <input type="text" class="form-control" wire:model="reg_file" id="reg_file">
                                @error('reg_file') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="file_pg">Total File Pages</label>
                                <input type="text" class="form-control" wire:model="file_pg" id="file_pg">
                                @error('file_pg') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="no_plate">Computerized Number Plate</label>
                                <input type="text" class="form-control" wire:model="no_plate" id="no_plate">
                                @error('no_plate') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="car_color">Car Color</label>
                                <input type="text" class="form-control" wire:model="car_color" id="car_color">
                                @error('car_color') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="amount">Amount (in Digits)</label>
                                <input type="text" class="form-control" wire:model="amount" id="amount">
                                @error('amount') <span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-3 form-group mb-2">
                                <label for="amount_words">Amount (in Words)</label>
                                <input type="text" class="form-control" wire:model="amount_words" id="amount_words">
