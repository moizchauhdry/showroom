<div wire:ignore.self class="modal fade" id="invoice_detail_modal" tabindex="-1" role="dialog"
    aria-labelledby="invoice_detail_modal_label" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="invoice_detail_modal_label"><b>Invoice Details</b></h5>
                        ...
                        <div class="card p-3 mb-3">
                            <div class="row">
                                <div class="col-md-3 form-group mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm" wire:model="s_name"
                                        id="s_name">
                        ...
                        <div class="card p-3 mb-3">
                            <div class="row">
                                <div class="col-md-3 form-group mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm" wire:model="b_name"
                                        id="b_name">
                                ...
                                <div class="col-md-3 form-group mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm" wire:model="b_cnic"
                                        id="b_cnic">
                        ...
                        <div class="card p-3 mb-3">
                            <div class="row">
                                <div class="col-md-3 form-group mb-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm" wire:model="reg_no"
                                        id="reg_no">
