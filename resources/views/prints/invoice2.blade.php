...
<body>
    ...
    <div>
        <table>
            ...
            <tr>
                <td style="padding:5px" colspan="2">
                    <div class="border-bottom">
                        ...
                        <span class="dynamic">Lorem ipsum dolor sit amet,
                            consectetur adipisicing elit. Blanditiis, architecto?</span>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="padding:5px">
                    <div class="border-bottom">
                        ...
                        <span class="dynamic">{{$invoice->amount}}</span>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding:5px" colspan="2">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa perferendis fuga et facere, nisi
                    officiis
                    fugiat quasi alias! Architecto voluptatibus nam alias, voluptatum consequatur, veniam tempora
                    asperiores
                    itaque amet magnam labore. Fugit veniam in expedita distinctio quaerat, voluptatem facilis
                    doloremque quas
                    tempora sunt iusto quod est ipsa soluta magni impedit?
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding:5px" colspan="2">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Incidunt enim iure saepe commodi obcaecati
                    aliquam quam blanditiis et velit animi!
                </td>
            </tr>
        </table>
